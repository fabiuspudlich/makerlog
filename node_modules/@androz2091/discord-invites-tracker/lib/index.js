...
class InvitesTracker extends events_1.EventEmitter {
    ...
    async handleGuildMemberAdd(member) {
        ...
        let isVanity = false;
        if (usedInvites.length === 0 && member.guild.features.includes(discord_js_1.GuildFeature.VanityURL)) {
                ...
                guild.members.me.fetch().then(() => {
                    ...
                    if (guild.members.me.permissions.has(discord_js_1.PermissionFlagsBits.ManageGuild)) {
                        guild.invites.fetch().then((invites) => {
                            ...
                            if (guild.features.includes(discord_js_1.GuildFeature.VanityURL) && this.options.fetchVanity) {
